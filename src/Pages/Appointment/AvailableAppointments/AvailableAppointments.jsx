...
const AvailableAppointments = ({selectedDate}) => {
    ...
    // useEffect(() => {
    //     fetch('https://final-server-p20dc2jtt-arafat-rahmans-projects.vercel.app/appointmentOptions')
    //     .then(res => res.json())
    ...
    const { data: appointmentOption = [], refetch, isLoading } = useQuery({
        ...
        queryFn: async()=>{
            const res = await fetch(`https://final-server-p20dc2jtt-arafat-rahmans-projects.vercel.app/appointmentOptions?date=${date}`);
